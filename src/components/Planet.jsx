   ...
   function setActivePlanetContent() {
      if (submenuTabs === "overview") {
         return (
            <>
               ...
               <div className="planet-info">
                  ...
                  <p>
                     Source: <a href={overview.source}>Wikipedia<img src="./images/icon-source.svg" alt="source-icon"/></a>
                  </p>
               </div>
            </>
         );
         ...
         return (
            <>
               <motion.div 
               animate={ {rotate: 180, transition:{duration: .5} } }
               className="image-container">
                  <img 
               ...
               <div className="planet-info">
                  ...
                  <p>
                     Source: <a href={structure.source}>Wikipedia<img src="./images/icon-source.svg" alt="source-icon"/></a>
                  </p>
               </div>
            </>
         );
         ...
         return (
            <>
               ...
               <div className="planet-info">
                  ...
                  <p>{geology.content}</p>
                  <p>
                     Source: <a href={geology.source}>Wikipedia<img src="./images/icon-source.svg" alt="source-icon"/></a>
                  </p>
               </div>
            </>
         );
   ...
   return (
      <>
         <main>
            <article 
            animate={ {} }
            className="planet-article">
               <>{activePlanetContent}</>
               <div className="submenu">
                  {tabs.map((tab, index) => {
                     return (
                        <button
                           className={isActive === index ? `active ${activePlanet.name.toLowerCase()}` : null}
                           key={index}
